...
include "config/con1.php";
   ...
   // echo   $yearofreleases.$producer.$nameofcollection.$cardnumber.$cardname.$team.$sporttype.$settype.$parallel.$printrun.$title1.$title2.$title3;
    ...
    $sql="INSERT INTO custom_checklist(year_of_releases,producer,name_of_collection,card_number,card_name,team,sporttype,set_type,parallel,print_run,title1,title2,title3)VALUES('$yearofreleases','$producer', '$nameofcollection','$cardnumber','$cardname','$team','$tox[sport_type]','$settype','$parallel','$printrun','0','0','0')";
